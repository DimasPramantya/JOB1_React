...
const AdminJadwalClient = () => {
    ...
    const handleSubmitAdd = async(event)=>{
        ...
        try {
            ...
            const response = await axios.post("http://localhost:5000/super-user/post-meeting-client",{tanggal,nama_client});
    ...
    const handleSubmitDel = async(event)=>{
        ...
        try {
            ...
            const idLogClient = formData.get('idMeetingClient').toString();
            await axios.post(`http://localhost:5000/super-user/delete-meeting-client/${idLogClient}`);
                                    ...
                                    <div className="p-2 grid grid-cols-5 border-b-2 border-slate-400">
                                        ...
                                        <div className="col-span-1">
                                            <form onSubmit={handleSubmitDel}>
                                                <input type="hidden" name="idMeetingClient" value={item.id}/>
...
export default AdminJadwalClient;